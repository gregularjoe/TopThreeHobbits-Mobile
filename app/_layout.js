...
/**
 * HomeLayout component that sets up the main layout of the app.
 * It includes the NavBar, HobbitContext provider, and SQLiteProvider.
 *
 ...
 * Creates the hobbits table if it does not exist and inserts initial data.
 *
 * @param {SQLiteDatabase} db - The SQLite database instance.
 */
async function initializeDB(db) {
  // This drops the table and resets it, Just here for development ease.
//   await db.execAsync(`DROP TABLE hobbits`);
  await db.execAsync(`
...
/**
 * Styles for the HomeLayout component.
 */
